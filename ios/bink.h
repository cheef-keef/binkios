...
EXPGROUP(_NullGroup)
#define BinkDate    "2021-05-12" EXPMACRO    

#define BinkVersion     "2021.05" EXPMACRO
#define BinkMajorVersion    2021  EXPMACRO    
#define BinkMinorVersion      05  EXPMACRO
#define BinkReleaseNumber      1  EXPMACRO 
